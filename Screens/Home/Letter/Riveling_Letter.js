...
//       employeeName: formData.employeeName,
//       currentDate: formData.currentDate.toISOString().split('T')[0],
//       dateOfjoing: formData.dateOfJoining.toISOString().split('T')[0], // Note: API expects 'dateOfjoing' to match web version
//       resignationDate: formData.resignationDate.toISOString().split('T')[0],
//       lastworkingdate: formData.lastWorkingDate.toISOString().split('T')[0],
//       designation: formData.designation,
//       department: formData.department,
...
//       employeeName: item.employeeName || '',
//       currentDate: item.currentDate ? new Date(item.currentDate) : new Date(),
//       dateOfJoining: item.dateOfjoing ? new Date(item.dateOfjoing) : new Date(),
//       resignationDate: item.resignationDate ? new Date(item.resignationDate) : new Date(),
//       lastWorkingDate: item.lastworkingdate ? new Date(item.lastworkingdate) : new Date(),
//       designation: item.designation || '',
//       department: item.department || '',
...
//           <p>The details of your employment with Royaalmede Jan Dhan Multi Urban Nidhi LID are as below:</p>
//           <ol class="list">
//             <li>Date of Joining: <b>${data.dateOfjoing ? new Date(data.dateOfjoing).toLocaleDateString('en-GB') : 'N/A'}</b></li>
//             <li>Last Working Date: <b>${data.lastworkingdate ? new Date(data.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}</b></li>
//             <li>Designation: <b>${data.designation}</b></li>
//             <li>Department: <b>${data.department}</b></li>
//             <li>Location: <b>${data.location}</b></li>
...
//   const formFields = [
//     { label: 'Employee Name', icon: 'person', key: 'employeeName', keyboardType: 'default', autoCapitalize: 'words' },
//     { label: 'Current Date', icon: 'event', key: 'currentDate', type: 'date' },
//     { label: 'Date of Joining', icon: 'event', key: 'dateOfJoining', type: 'date' },
//     { label: 'Resignation Date', icon: 'event', key: 'resignationDate', type: 'date' },
//     { label: 'Last Working Date', icon: 'event', key: 'lastWorkingDate', type: 'date' },
//     { label: 'Designation', icon: 'work', key: 'designation', keyboardType: 'default', autoCapitalize: 'words' },
//     { label: 'Department', icon: 'business', key: 'department', keyboardType: 'default', autoCapitalize: 'words' },
//     { label: 'Location', icon: 'location-on', key: 'location', keyboardType: 'default', autoCapitalize: 'words' },
//   ];
...
//         { key: 'dateOfjoing', label: 'Date of Joining' },
...
//           onPress={() => column.key !== 'action' && handleSort(column.key)}
//         >
//           <Text style={styles.tableHeaderText}>{column.label}</Text>
//           {column.key !== 'action' && renderSortIcon(column.key)}
//         </TouchableOpacity>
//       ))}
//     </View>
//   );
...
//       <Text style={[styles.tableCell, styles.idCell]}>{index}</Text>
//       <Text style={styles.tableCell}>{item.employeeName}</Text>
//       <Text style={styles.tableCell}>{new Date(item.currentDate).toLocaleDateString('en-GB')}</Text>
//       <Text style={styles.tableCell}>{new Date(item.dateOfjoing).toLocaleDateString('en-GB')}</Text>
//       <Text style={styles.tableCell}>{new Date(item.resignationDate).toLocaleDateString('en-GB')}</Text>
//       <Text style={styles.tableCell}>
//         {item.lastworkingdate ? new Date(item.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}
//       </Text>
...
//         <TouchableOpacity style={styles.actionButton} onPress={() => handleView(item.id)}>
...
//     >
//       <View style={styles.formContainer}>
//         <Text style={styles.formTitle}>Relieving Letter</Text>
//         {formFields.map((field, index) =>
//           field.type === 'date' ? renderDateField(field) : renderInput(field, index)
//         )}
//         <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
...
//                       <View style={[styles.contentRow, { marginTop: 10 }]}>
//                         {[
//                           { text: `Date of Joining: ${letterData.dateOfjoing ? new Date(letterData.dateOfjoing).toLocaleDateString('en-GB') : 'N/A'}`, bold: letterData.dateOfjoing ? new Date(letterData.dateOfjoing).toLocaleDateString('en-GB') : 'N/A' },
//                           { text: `Last Working Date: ${letterData.lastworkingdate ? new Date(letterData.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}`, bold: letterData.lastworkingdate ? new Date(letterData.lastworkingdate).toLocaleDateString('en-GB') : 'N/A' },
//                           { text: `Designation: ${letterData.designation}`, bold: letterData.designation },
//                           { text: `Department: ${letterData.department}`, bold: letterData.department },
//                           { text: `Location: ${letterData.location}`, bold: letterData.location },
...
const RelievingLetter = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      employeeName: formData.employeeName,
      currentDate: formData.currentDate.toISOString().split('T')[0],
      dateOfjoing: formData.dateOfJoining.toISOString().split('T')[0],
      resignationDate: formData.resignationDate.toISOString().split('T')[0],
      lastworkingdate: formData.lastWorkingDate.toISOString().split('T')[0],
      designation: formData.designation,
      department: formData.department,
  ...
  const generatePDF = async (data) => {
    const html = `
      ...
      <body>
        ...
        <h3 class="letter-title">Relieving Letter Cum Experience Letter</h3>
        
        <div class="letter-details">
          <div class="recipient-info">
            <p><strong>Name:</strong> ${data.employeeName}</p>
            <p><strong>Date:</strong> ${new Date(data.currentDate).toLocaleDateString('en-GB')}</p>
          </div>
          
          <div class="letter-content">
            <p>Dear <strong>${data.employeeName}</strong>,</p>
            <p>With reference to your resignation dated <strong>${new Date(data.resignationDate).toLocaleDateString('en-GB')}</strong>, the same has been accepted, and you are relieved from your services w.e.f the close of business hours of <strong>${data.lastworkingdate ? new Date(data.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}</strong>.</p>
            <p>The details of your employment with AG Construction are as below:</p>
            <ol class="employment-list">
              <li>Date of Joining: <strong>${data.dateOfjoing ? new Date(data.dateOfjoing).toLocaleDateString('en-GB') : 'N/A'}</strong></li>
              <li>Last Working Date: <strong>${data.lastworkingdate ? new Date(data.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}</strong></li>
              <li>Designation: <strong>${data.designation}</strong></li>
              <li>Department: <strong>${data.department}</strong></li>
  ...
  const formFields = [
    ...
    { label: 'Current Date', key: 'currentDate', type: 'date' },
  ...
  const renderRelievingItem = ({ item, index }) => (
    <View style={styles.slipCard}>
      ...
      <View style={styles.cardDetails}>
        ...
        <View style={styles.detailRow}>
          <Text style={styles.detailText}>Joining: {new Date(item.dateOfjoing).toLocaleDateString('en-GB')}</Text>
          <Text style={styles.detailText}>Resignation: {new Date(item.resignationDate).toLocaleDateString('en-GB')}</Text>
        </View>
        <View style={styles.detailRow}>
          <Text style={styles.detailText}>Last Working: {item.lastworkingdate ? new Date(item.lastworkingdate).toLocaleDateString('en-GB') : 'N/A'}</Text>
        </View>
      </View>
    </View>
  );
  ...
  const renderEmptyComponent = () => {
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyTitle}>No relieving letters found</Text>
        <Text style={styles.emptyText}>
          {searchQuery ? 'Try a different search term' : 'Create your first relieving letter to get started'}
        </Text>
      </View>
    );
  };
  ...
  const renderFormView = () => (
    ...
    >
      <View style={styles.formContainer}>
        <Text style={styles.formTitle}>AG Construction Relieving Letter Form</Text>
        {formFields.map((field, index) =>
          field.type === 'date' ? renderDateField(field) : renderInput(field, index)
        )}
        <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
          ...
          >
            <Text style={styles.submitButtonText}>
              {isEditMode ? 'Update Relieving Letter' : 'Generate Relieving Letter'}
            </Text>
  ...
  const renderListView = () => (
    <View style={styles.tableContainer}>
      <Text style={styles.listTitle}>All Relieving Letters</Text>
      <View style={styles.searchContainer}>
        <Feather name="search" size={20} color="#6A5ACD" style={styles.searchIcon} />
        <TextInput
          style={styles.searchInput}
    ...
    <View style={styles.slipContainer}>
      ...
      >
        <View style={styles.slipContent}>
          ...
          <Text style={styles.letterTitle}>Subject - Relieving Letter Cum Experience Letter</Text>

          {/* Employee Details */}
          <View style={styles.employeeInfo}>
            <Text style={styles.infoText}>
              <Text style={styles.boldText}>Name:</Text> {letterData.employeeName}
            </Text>
            <Text style={styles.infoText}>
              <Text style={styles.boldText}>Date:</Text> {formatDate(new Date(letterData.currentDate))}
            </Text>
          </View>
          ...
          <View style={styles.letterContent}>
            ...
            <Text style={styles.infoText}>
              With reference to your resignation dated <Text style={styles.boldText}>{formatDate(new Date(letterData.resignationDate))}</Text>, the same has been accepted, and you are relieved from your services w.e.f the close of business hours of <Text style={styles.boldText}>{letterData.lastworkingdate ? formatDate(new Date(letterData.lastworkingdate)) : 'N/A'}</Text>.
            </Text>
            <Text style={styles.infoText}>
              The details of your employment with AG Construction are as below:
            </Text>
            <View style={styles.employmentList}>
              <View style={styles.listItem}>
                <Text style={styles.infoText}>
                  1. Date of Joining: <Text style={styles.boldText}>{letterData.dateOfjoing ? formatDate(new Date(letterData.dateOfjoing)) : 'N/A'}</Text>
                </Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.infoText}>
                  2. Last Working Date: <Text style={styles.boldText}>{letterData.lastworkingdate ? formatDate(new Date(letterData.lastworkingdate)) : 'N/A'}</Text>
                </Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.infoText}>
                  3. Designation: <Text style={styles.boldText}>{letterData.designation}</Text>
                </Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.infoText}>
                  4. Department: <Text style={styles.boldText}>{letterData.department}</Text>
                </Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.infoText}>
                  5. Location: <Text style={styles.boldText}>{letterData.location}</Text>
                </Text>
              </View>
            </View>
            <Text style={styles.infoText}>
            ...
            <Text style={styles.infoText}>For AG Construction</Text>
            <Text style={[styles.infoText, styles.signature]}>Chief Executive Officer</Text>
          </View>
